    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            if self.algoMode == "TD3":
                plt.savefig("D:\JunHill\Projects\stock_first_try\plot\_td3\iteration{}.png".format(self.iteration))
            elif self.algoMode == "DDPG":
                plt.savefig('D:\JunHill\Projects\stock_first_try\plot\ddpg\iteration{}.png'.format(self.iteration))
            elif self.algoMode == "SAC":
                plt.savefig('D:\JunHill\Projects\stock_first_try\plot\sac\iteration{}.png'.format(self.iteration))
            else:
